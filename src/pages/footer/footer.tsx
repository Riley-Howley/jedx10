        ...
        <footer className={styles.footer}>
            ...
            <div className={styles.topSection}>
                <div className={styles.copyright}>
                    © 2023 JEDX10 Fitness. All rights reserved.
                </div>
            ...
            <div className={styles.mainContent}>
                ...
                <div className={styles.leftSection}>
                    <img src={Logo} alt="JEDX10 Logo" className={styles.logo} />
                ...
                {/* Center section with hours */}
                <div className={styles.centerSection}>
                    <div className={styles.hoursSection}>
                        <h3 className={styles.hoursTitle}>GYM HOURS</h3>
                        <p className={styles.hoursText}>Monday To Friday 9am - 5pm</p>
                        <p className={styles.hoursText}>Saturday & Sunday - Closed</p>
                    </div>
                    
                    <div className={styles.operatingSection}>
                        <h3 className={styles.hoursTitle}>Online Operating Hours</h3>
                        <p className={styles.hoursText}>Monday, Tuesday & Wednesday 9am - 5pm</p>
                    </div>
                </div>
